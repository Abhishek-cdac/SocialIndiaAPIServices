...
public class OnlineStatusUpdate extends ActionSupport {
	Log log=new Log();	
	...
	public String execute(){
		...
		String resetLogin = (String) Commonutility.toHasChkJsonRtnValObj(locObjRecvdataJson, "resetLogin");
		...
		if(flg){
			...
			if(result==true){
				...
				if(userMst!=null){
					...
					int userid=Integer.parseInt(rid);
					boolean isInsert=uam.updateOnlineStatus(userid, resetLogin);
					 if(isInsert){
