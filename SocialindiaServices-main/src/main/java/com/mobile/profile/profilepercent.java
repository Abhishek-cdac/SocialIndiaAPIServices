...
public class profilepercent extends ActionSupport {
	Log log=new Log();	
	...
	public String execute(){
		...
		System.out.println("************profile percent services******************");
		...
		try{
			...
			if(result==true){
				...
				if(societyKeyCheck==true){
					...
					if(userMst!=null){
						...
						int percentageCount=mobcom.getProfilePercentageCal(userMst);	
						locObjRspdataJson=new JSONObject();
						locObjRspdataJson.put("profile_percentage", String.valueOf(percentageCount));
			...
			locObjRspdataJson=new JSONObject();
			log.logMessage("Service code : "+servicecode+", Request values are not correct format", "info", profilepercent.class);
			...
			log.logMessage("Service code : ivrservicecode, Sorry, personalProfileList an unhandled error occurred", "info", profilepercent.class);
			locObjRspdataJson=new JSONObject();
