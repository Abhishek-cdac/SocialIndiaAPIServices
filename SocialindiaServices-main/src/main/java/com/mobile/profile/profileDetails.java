			...
			if(result==true){
				...
				if(userInfo!=null){
					...
					/*if(userInfo.getImageNameWeb()!=null && !userInfo.getImageNameWeb().equalsIgnoreCase("")){
						locObjRspdataJson.put("profilepic", System.getenv("SOCIAL_INDIA_BASE_URL")  +"/templogo/profile/web/"+userInfo.getUserId()+"/"+userInfo.getImageNameWeb());
					...
					if(userInfo.getImageNameMobile()!=null && !userInfo.getImageNameMobile().equalsIgnoreCase("")){
						...
						locObjRspdataJson.put("profilepic_thumbnail", System.getenv("SOCIAL_INDIA_BASE_URL")  +"/templogo/profile/mobile/"+userInfo.getUserId()+"/"+imageName+"_small."+limageFomat);
						locObjRspdataJson.put("profilepic", System.getenv("SOCIAL_INDIA_BASE_URL")  +"/templogo/profile/mobile/"+userInfo.getUserId()+"/"+userInfo.getImageNameMobile());
					}else{
