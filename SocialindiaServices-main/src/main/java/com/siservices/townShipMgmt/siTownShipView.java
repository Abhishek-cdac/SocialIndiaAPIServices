...
public class siTownShipView extends ActionSupport{
		...
		try{
			if(ivrparams!=null && !ivrparams.equalsIgnoreCase("null") && ivrparams.length()>0){
				...
				if(townShipMst!=null){
					...
					jsonFinalObj.put("noofflats", townShipMst.getNoOfSociety());
					jsonFinalObj.put("activationkey", townShipMst.getActivationKey());
					
					jsonFinalObj.put("country", townShipMst.getCountryId().getCountryName());
					jsonFinalObj.put("city", townShipMst.getCityId().getCityName());
					jsonFinalObj.put("state", townShipMst.getStateId().getStateName());
	//				jsonFinalObj.put("pincode", townShipMst.getPstlId().getPstlCode());
					jsonFinalObj.put("pincode", townShipMst.getPstlId());
					
					jsonFinalObj.put("countryid", Commonutility.toCheckNullEmpty(townShipMst.getCountryId().getCountryId()));
					jsonFinalObj.put("cityid", Commonutility.toCheckNullEmpty(townShipMst.getCityId().getCityId()));
					jsonFinalObj.put("stateid", Commonutility.toCheckNullEmpty(townShipMst.getStateId().getStateId()));
	//				jsonFinalObj.put("pincodeid", Commonutility.toCheckNullEmpty(townShipMst.getPstlId().getPstlId()));
					...
					if(townShipMst.getImprintName()==null){
						...
						jsonFinalObj.put("landmark", townShipMst.getEmailId());
					}
					...
					serverResponse(ivrservicecode,"01","R0003",mobiCommon.getMsg("R0174"),locObjRspdataJson);
				}
			...
			log.logMessage("Service code : ivrservicecode, Sorry, an unhandled error occurred", "info", siTownShipView.class);
			try {
