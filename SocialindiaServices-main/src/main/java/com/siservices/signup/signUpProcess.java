...
public class signUpProcess extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		String activationKey = (String) json.get("activationKey");
		System.out.println("==========activationKey===" + activationKey);
		flag = signup.checkActiveKey(activationKey);
		...
		if (flag == true) {
			...
			System.out.println("===================================userMaster============="+userMaster.getGroupCode().getGroupCode());
