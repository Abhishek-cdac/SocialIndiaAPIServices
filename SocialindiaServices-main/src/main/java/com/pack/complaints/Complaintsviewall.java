...
public class Complaintsviewall extends ActionSupport {
  ...
  private JSONObject toComplaintselect(JSONObject praDatajson, Session praSession){	
    ...
    try {
		...
		String filepathweb=System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/complaint/mobile/";
		String filepathlabweb=System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/labor/mobile/";
		String filepathmrchweb=System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/Merchant/mobile/";
		String filepathrest=System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/profile/mobile/";
		String filepathrestweb=System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/profile/web/";
