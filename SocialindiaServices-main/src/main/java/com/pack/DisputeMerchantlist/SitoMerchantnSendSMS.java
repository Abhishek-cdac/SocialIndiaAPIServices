...
public class SitoMerchantnSendSMS extends ActionSupport {
			...
			if (ivIsJson) {
				...
				if(merchantData!=null){
					...
					try {
			            ...
			            String qry = "FROM SmsTemplatepojo where " + "templateName ='Share Complaint ToMerchant' and status ='1'";
			            ...
			            smsMessage=smsMessage.replace("[BITLYURL]", dispute_issuetype);
			           ...
			           /* qry = common.smsTemplateParser(smsMessage, 1, "", "");
			            ...
			            sms.setSmsMobNumber(merchantData.getMrchntPhNo());
			            ...
			            log.logMessage("Exception in SitomerchantSendSMS admin flow smsFlow----> " + ex, "error",SitoMerchantSendEmail.class);
