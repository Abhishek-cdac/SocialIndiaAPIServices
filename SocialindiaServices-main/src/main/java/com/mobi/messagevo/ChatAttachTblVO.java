...
public class ChatAttachTblVO implements java.io.Serializable {
	...
	public ChatTblVO getChatId() {
		return chatId;
	}

	public void setChatId(ChatTblVO chatId) {
		this.chatId = chatId;
	}
