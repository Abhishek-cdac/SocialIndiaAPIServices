...
public class ChatTblVO implements Serializable {
	/**
	 * 
	 */
	...
	private UserMasterTblVo fromUsrId;
	private UserMasterTblVo toUsrId;
...
//	private String attachement;
	...
	public UserMasterTblVo getFromUsrId() {
		return fromUsrId;
	}

	public void setFromUsrId(UserMasterTblVo fromUsrId) {
		this.fromUsrId = fromUsrId;
	}

	public UserMasterTblVo getToUsrId() {
		return toUsrId;
	}

	public void setToUsrId(UserMasterTblVo toUsrId) {
