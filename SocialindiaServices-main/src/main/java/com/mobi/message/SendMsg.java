				...
				if (flg) {
					...
					if (flg) {
						...
						if (chatId != -1) {
							...
							String profileimgPath = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") + getText("external.view.profile.mobilepath")+ rid +"/";
							if (type == 2) {
								List<ChatTblVO> sendChatMsgObj = new ArrayList<ChatTblVO>();
								sendChatMsgObj = msgService.getchatInsertDetails(chatId);
								imagePathWeb = System.getenv("SOCIAL_INDIA_BASE_URL")   + getText("external.templogo") + getText("external.uploadfile.msg.img.webpath");
								imagePathMobi = System.getenv("SOCIAL_INDIA_BASE_URL")   + getText("external.templogo") +  getText("external.uploadfile.msg.img.mobilepath") ;
								videoPath = System.getenv("SOCIAL_INDIA_BASE_URL")   + getText("external.templogo") +  getText("external.uploadfile.msg.videopath");
								videoPathThumb = System.getenv("SOCIAL_INDIA_BASE_URL")   + getText("external.templogo") +  getText("external.uploadfile.msg.video.thumbpath");
								...
								imagePathWeb = System.getenv("SOCIAL_INDIA_BASE_URL")   + getText("external.templogo") + getText("external.uploadfile.groupmsg.img.webpath");
								imagePathMobi = System.getenv("SOCIAL_INDIA_BASE_URL")   + getText("external.templogo") +  getText("external.uploadfile.groupmsg.img.mobilepath") ;
								videoPath = System.getenv("SOCIAL_INDIA_BASE_URL")   + getText("external.templogo") +  getText("external.uploadfile.groupmsg.videopath");
								videoPathThumb = System.getenv("SOCIAL_INDIA_BASE_URL")   + getText("external.templogo") +  getText("external.uploadfile.groupmsg.video.thumbpath");
