...
import com.mobile.wishlist.wishDaoServices;
		...
		try {
			if (complainUniqId != null) {
				...
				if(complainUniqId.getUsrRegTblByFromUsrId().getImageNameMobile()!=null){
					finalJsonarr.put("profile_pic",Commonutility.toCheckNullEmpty(System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/profile/mobile/"+complainUniqId.getUsrRegTblByFromUsrId().getImageNameMobile()));}
					else
					{
