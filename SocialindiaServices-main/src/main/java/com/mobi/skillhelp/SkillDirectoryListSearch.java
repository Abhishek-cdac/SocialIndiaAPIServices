...
//						loborDataObj = skillService.skillDirectoryLaborData(rid);
						...
						if (loborDataObj != null) {
							...
							String profileimgPath = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") + getText("external.inner.laborfldr") + getText("external.inner.mobilepath");
