...
//			responsDataJson.put("labor_det", dataJsonArray);
	...
	public JSONArray privacyListCategory() {
		...
		try {
			...
			jsonPack.put("cate_url",System.getenv("SOCIAL_INDIA_BASE_URL") +getText("external.templogo")+getText("external.cate.img.path")+"1"+getText("external.cate.img.path.extension"));
			jsonPack.put("is_list_users","0");
			returnJsonData.put(jsonPack);
			jsonPack = new JSONObject();
			jsonPack.put("cate_type","2");
			jsonPack.put("cate_name",getText("cate.type.2"));
			jsonPack.put("cate_url",System.getenv("SOCIAL_INDIA_BASE_URL") +getText("external.templogo")+getText("external.cate.img.path")+"2"+getText("external.cate.img.path.extension"));
			jsonPack.put("is_list_users","0");			
			returnJsonData.put(jsonPack);
			jsonPack = new JSONObject();
			jsonPack.put("cate_type","3");
			jsonPack.put("cate_name",getText("cate.type.3"));
			jsonPack.put("cate_url",System.getenv("SOCIAL_INDIA_BASE_URL") +getText("external.templogo")+getText("external.cate.img.path")+"3"+getText("external.cate.img.path.extension"));
			jsonPack.put("is_list_users","0");
			returnJsonData.put(jsonPack);
			jsonPack = new JSONObject();
			jsonPack.put("cate_type","4");
			jsonPack.put("cate_name",getText("cate.type.4"));
			jsonPack.put("cate_url",System.getenv("SOCIAL_INDIA_BASE_URL") +getText("external.templogo")+getText("external.cate.img.path")+"4"+getText("external.cate.img.path.extension"));
...
//				/responsDataJson.put("societies", jsonArry);
				...
				/*	if (Commonutility.checkempty(userData.getImageNameMobile())) {
					...
					if(userObj.getImageNameMobile()!=null && !userObj.getImageNameMobile().equalsIgnoreCase("")){
						String imageName = FilenameUtils.getBaseName(userObj.getImageNameMobile());
						String limageFomat = FilenameUtils.getExtension(userObj.getImageNameMobile());
						responsDataJson.put("profilepic_thumbnail", System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/profile/mobile/"+userObj.getUserId()+"/"+imageName+"_small."+limageFomat);
						responsDataJson.put("profilepic", System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/profile/mobile/"+userObj.getUserId()+"/"+userObj.getImageNameMobile());
		...
		try {
			...
			if (adspostObj != null) {
				...
				if(adspostObj.getUserId()!=null && adspostObj.getUserId().getImageNameMobile()!=null){
					returnJsonData.put("profile_picture", System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/addpost/mobile/"+adspostObj.getUserId().getUserId()+"/"+adspostObj.getUserId().getImageNameMobile());	
				...
				for (Iterator<MvpAdpostAttchTbl> itObj = adPostAttachList
					...
					comVido = new JSONObject();
						if(adPostAttachObj.getIvrBnFILE_TYPE() == 1)
						{
							...
							images.put("img_url",System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/addpost/mobile/"+adPostAttachObj.getPostUniqueId().getPostUniqueId()+"/"+adPostAttachObj.getAttachName());
							}else{
								images.put("img_url","");
							}
						}
						 if(adPostAttachObj.getIvrBnFILE_TYPE() == 2)
						{
							...
							comVido.put("thumb_img", System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/addpost/thumbimage/"+adPostAttachObj.getPostUniqueId().getPostUniqueId()+"/"+adPostAttachObj.getThumbImage());
							}else{
								comVido.put("thumb_img","");
							}if(adPostAttachObj.getAttachName()!=null){
							comVido.put("video_url", System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/addpost/videos/"+adPostAttachObj.getPostUniqueId().getPostUniqueId()+"/"+adPostAttachObj.getAttachName());
							}else{
								comVido.put("video_url","");
							}
		...
		try {
			...
			if (eventTblObj != null) {
				...
				if(eventTblObj.getIvrBnEVENT_CRT_USR_ID()!=null && eventTblObj.getIvrBnEVENT_CRT_USR_ID().getImageNameMobile()!=null){
					String externalUserImagePath = System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/profile/mobile/"+eventTblObj.getIvrBnEVENT_CRT_USR_ID().getUserId()+"/"+eventTblObj.getIvrBnEVENT_CRT_USR_ID().getImageNameMobile();
				...
				if(eventTblObj.getIvrBnEVENT_FILE_NAME()!=null){
					...
					String eventpath=System.getenv("SOCIAL_INDIA_BASE_URL") +"/templogo/"+getText("external.inner.eventfldr")+"/mobile/"+eventId+"/"+eventTblObj.getIvrBnEVENT_FILE_NAME();
							...
							if (fileArr.length == 4) {							
								...
								if (Commonutility.checkempty(fileType) && Commonutility.checkLengthNotZero(fileType)) {									
									...
									if((int)objList[1]==9|| (int)objList[1]==10 || (int)objList[1]==8 || (int)objList[1]==12) {
										...
										imagePathWeb = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") + getText("external.uploadfile.event.img.webpath");
										imagePathMobi = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") +  getText("external.uploadfile.event.img.mobilepath");
										videoPath = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") +  getText("external.uploadfile.event.videopath");
										videoPathThumb = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") +  getText("external.uploadfile.event.video.thumbpath");
									}
									if((int)objList[1]==7) {
										if (objList[27] != null) {					
										...
										imagePathWeb = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") +"complaint/web/";
										imagePathMobi = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") +"complaint/mobile/";
										videoPath = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") +"complaint/videos/";
										videoPathThumb = System.getenv("SOCIAL_INDIA_BASE_URL")  + getText("external.templogo") +"complaint/thumbimage/";
									}
