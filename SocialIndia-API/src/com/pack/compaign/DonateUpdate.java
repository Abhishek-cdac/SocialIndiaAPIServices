...
import com.pack.flashnews.FlashnewUpdate;
import com.pack.utilitypkg.Commonutility;
import com.sisocial.load.HibernateUtil;
import com.social.login.EncDecrypt;
import com.social.utils.Log;

public class DonateUpdate extends ActionSupport{
	/**
	 * 
	 */
	...
	public String execute(){
		...
		try{
			...
			if(ivrparams!=null && !ivrparams.equalsIgnoreCase("null") && ivrparams.length()>0){
				...
				if (ivIsJson) {
					...
					if(locvrDecissBlkflagchk!="" && !locvrDecissBlkflagchk.equalsIgnoreCase("") && locvrDecissBlkflagchk.equalsIgnoreCase("1")){// insert Feedback
						locvrFnrst = DonateUtility.toInsertFunction(locObjRecvdataJson);
						...
						if(locSbt!=null && locSbt.length>=2){
							if(locSbt[0]!=null && locSbt[0].equalsIgnoreCase("success") && !locSbt[0].equalsIgnoreCase("-1")&& !locSbt[0].equalsIgnoreCase("0")){
								locRtnSrvId="SI360001";locRtnStsCd="0"; locRtnRspCode="S360001";locRtnMsg=getText("Campaign.insert.success");
								AuditTrial.toWriteAudit(getText("CAMP001"), "CAMP001", ivrEntryByusrid);
							}else{
								locRtnSrvId="SI360001";locRtnStsCd="1"; locRtnRspCode="E330001";locRtnMsg=getText("Campaign.insert.error");
								AuditTrial.toWriteAudit(getText("CAMP002"), "CAMP002", ivrEntryByusrid);
							}
						}else{
							locRtnSrvId="SI360001";locRtnStsCd="1"; locRtnRspCode="E360001";locRtnMsg=getText("Campaign.insert.error");
							AuditTrial.toWriteAudit(getText("CAMP002"), "CAMP002", ivrEntryByusrid);
						}
						...
						locObjRspdataJson = DonateUtility.toSingleSelect(locObjRecvdataJson,locObjsession);
						...
						if(locvrFnrst==null || locvrFnrst.equalsIgnoreCase("null") || locvrFnrst.equalsIgnoreCase("") || !locvrFnrst.equalsIgnoreCase("Error")){
							...
							locRtnSrvId="SI3600003";locRtnStsCd="0"; locRtnRspCode="S3600003";locRtnMsg=getText("Campaign.select.success");
						//	AuditTrial.toWriteAudit(getText("FNEWS003"), "FNEWS003", ivrEntryByusrid);
							...
							locRtnSrvId="SI3600003";locRtnStsCd="1"; locRtnRspCode="E3600003";locRtnMsg=getText("Campaign.select.error");
							AuditTrial.toWriteAudit(getText("CAMP004"), "CAMP004", ivrEntryByusrid);
						}
						...
						locvrFnrst = DonateUtility.toUpdateFunction(locObjRecvdataJson,locObjsession);
						String locSbt[]=locvrFnrst.split("!_!");	
						System.out.println(locSbt[0]);
						if(locSbt!=null && locSbt.length>=2){
							if(locSbt[0]!=null && locSbt[0].equalsIgnoreCase("success") && !locSbt[0].equalsIgnoreCase("-1")&& !locSbt[0].equalsIgnoreCase("0")){
								locRtnSrvId="SI3600002";locRtnStsCd="0"; locRtnRspCode="S330001";locRtnMsg=getText("Campaign.update.success");
								AuditTrial.toWriteAudit(getText("CAMP005"), "CAMP005", ivrEntryByusrid);
							}else{
								locRtnSrvId="SI3600002";locRtnStsCd="1"; locRtnRspCode="E330001";locRtnMsg=getText("Campaign.update.error");
								AuditTrial.toWriteAudit(getText("CAMP006"), "CAMP006", ivrEntryByusrid);
							}
						}else{
							locRtnSrvId="SI3600002";locRtnStsCd="1"; locRtnRspCode="E330001";locRtnMsg=getText("Campaign.update.error");
							AuditTrial.toWriteAudit(getText("CAMP006"), "CAMP006", ivrEntryByusrid);
						...
						locvrFnrst = DonateUtility.toDeleteaction(locObjRecvdataJson,locObjsession);
						String locSbt[]=locvrFnrst.split("!_!");	
						System.out.println(locSbt[0]);
						if(locSbt!=null && locSbt.length>=2){
							if(locSbt[0]!=null && locSbt[0].equalsIgnoreCase("success") && !locSbt[0].equalsIgnoreCase("-1")&& !locSbt[0].equalsIgnoreCase("0")){
								locRtnSrvId="SI3600002";locRtnStsCd="0"; locRtnRspCode="S330001";locRtnMsg=getText("Campaign.deactive.success");
								AuditTrial.toWriteAudit(getText("CAMP007"), "CAMP007", ivrEntryByusrid);
							}else{
								locRtnSrvId="SI3600002";locRtnStsCd="1"; locRtnRspCode="E330001";locRtnMsg=getText("Campaign.deactive.error");
								AuditTrial.toWriteAudit(getText("CAMP008"), "CAMP008", ivrEntryByusrid);
							}
						}else{
							locRtnSrvId="SI3600002";locRtnStsCd="1"; locRtnRspCode="E330001";locRtnMsg=getText("Campaign.deactive.error");
							AuditTrial.toWriteAudit(getText("CAMP008"), "CAMP008", ivrEntryByusrid);
						...
						locvrFnrst="";
						locObjRspdataJson=new JSONObject();
						AuditTrial.toWriteAudit(getText("CAMP009"), "CAMP009", ivrEntryByusrid);
					...
					locObjRspdataJson=new JSONObject();
					AuditTrial.toWriteAudit(getText("CAMP0010"), "CAMP0010", ivrEntryByusrid);
				...
				locObjRspdataJson=new JSONObject();
				AuditTrial.toWriteAudit(getText("CAMP0014"), "CAMP0014", ivrEntryByusrid);
			...
			AuditTrial.toWriteAudit(getText("CAMP0015"), "CAMP0015", ivrEntryByusrid);
			locObjRspdataJson=new JSONObject();
