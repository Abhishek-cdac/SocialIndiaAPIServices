...
public class Functionviewall extends ActionSupport{
	...
	public String execute(){
		...
		try{
			...
			if(ivrparams!=null && !ivrparams.equalsIgnoreCase("null") && ivrparams.length()>0){
				...
				locObjRspdataJson = togetallfunction(locObjRecvdataJson);
	...
	private JSONObject togetallfunction(JSONObject prmDatajson){
		...
		try{
			...
			lvrSql = "select functionId, functionName from FunctionMasterTblVO where statusFlag = 1 order by functionName asc";
