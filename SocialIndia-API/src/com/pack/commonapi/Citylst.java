...
public class Citylst extends ActionSupport {
	...
	public String execute() {
		...
		try {
			...
			if (ivIsJson) {
				...
				ivrstateid=(String) Commonutility.toHasChkJsonRtnValObj(locObjRecvJson, "stateid");
				locVrSlQry="select  cityId, cityName from CityMasterTblVO where stateId="+ivrstateid+"";
				...
				locObjdataJson=new JSONObject();
				serverResponse("SI1003","1","E0001","Request values not not correct format",locObjdataJson);
			}}else{
				locObjdataJson=new JSONObject();
			...
			System.out.println("Exception found in Citylst.action execute() Method : "+ e);
			locObjdataJson=new JSONObject();			
			serverResponse("SI1003","2","E0002","Sorry, an unhandled error occurred",locObjdataJson);
		} finally {
