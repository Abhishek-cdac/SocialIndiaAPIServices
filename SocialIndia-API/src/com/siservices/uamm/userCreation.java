...
//			userInfo.setPstlId(postMst);
		...
		if (result.equalsIgnoreCase("insertsuccess")) {
			// bitly url call
			String locbityurl = GetBitlyLink.toGetBitlyLinkMthd(getText("SOCIAL_INDIA_BASE_URL") + getText("project.login.url"), "yes", getText("bitly.accesstocken"), getText("bitly.server.url"));
			//Send Email			
