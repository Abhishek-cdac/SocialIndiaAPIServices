...
public class GeneralDocMasterList extends ActionSupport{
	...
	public String execute(){
		...
		try{
			...
			if(ivrparams!=null && !ivrparams.equalsIgnoreCase("null") && ivrparams.length()>0){
				...
				lsvSlQry="select ivrBnDOC_TYP_ID,ivrBnDOC_TYP_NAME from DoctypMasterTblVO where ivrBnACT_STS='1' and ivrBnDOC_TYP_NAME<>'MAINTENANCE DOCUMENT'";
