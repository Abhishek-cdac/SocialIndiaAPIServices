...
public class DBCPConnectionProvider implements ConnectionProvider {
	...
	public void configure(Properties props) throws HibernateException {
		try {
			...
			System.out.println("isolationLevel : "+isolationLevel);
	...
	protected void logStatistics() {
		...
		//System.out.println("active: " + ds.getNumActive() + " (max: "+ ds.getMaxActive() + ")   " + "idle: " + ds.getNumIdle()+ "(max: " + ds.getMaxIdle() + ")");
		//}
	}
...
//		try{
//		Connection cnn=new DBCPConnectionProvider().getConnection();
