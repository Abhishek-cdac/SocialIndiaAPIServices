...
public class Testconnection extends ActionSupport {
	...
	public String execute(){
		...
		boolean flg = true;
		try {
			ivrservicecode = getText("test.connection");
			locErrorvalStrBuil = new StringBuilder();
			String townshipid = null;
			String timestamp = null;
			String societyKey = null;
			log.logMessage("ivrservicecode : " + ivrservicecode , "info", Testconnection.class);
			...
			log.logMessage("flg : " + flg , "info", Testconnection.class);
			if (flg) {				
			...
			locObjRspdataJson=new JSONObject();
			log.logMessage("Service code : " + ivrservicecode + ", Sorry, an unhandled error occurred", "error", Testconnection.class);
