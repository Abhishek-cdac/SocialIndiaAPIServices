...
public class DeleteEvoting extends ActionSupport {
	Log log=new Log();	
	...
	public String execute(){
		...
		try{
			...
			if (ivIsJson) {		
				...
				String evotingId = (String) Commonutility.toHasChkJsonRtnValObj(locObjRecvdataJson, "pass_id");
			...
			if(userMst!=null){
				...
				String sql="update MvpEvotingMstTbl set statusFlag=0 where evotingId="+evotingId+" and usrRegTbl.userId="+rid;
				boolean carPoolingId=carPoolinghbm.runupdateQueryCarPoolingTable(sql);
				locObjRspdataJson=new JSONObject();
				if(carPoolingId){
				serverResponse(servicecode,"00","R0157",mobiCommon.getMsg("R0157"),locObjRspdataJson);
				}else{
					locObjRspdataJson=new JSONObject();
