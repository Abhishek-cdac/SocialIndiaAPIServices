			...
			adPostList=adPost.getAdPostDetailForUniqueList(rid,ad_id);
				...
				for (Iterator<MvpAdpostTbl> it = adPostList
					...
					if(adPostObj.getUserId()!=null && adPostObj.getUserId().getImageNameMobile()!=null){
						finalJsonarr.put("profile_picture", getText("SOCIAL_INDIA_BASE_URL") +"/templogo/complaint/mobile/"+adPostObj.getUserId().getUserId()+"/"+adPostObj.getUserId().getImageNameMobile());	
				...
				for (Iterator<MvpAdpostAttchTbl> itObj = adPostAttachList
					...
					comVido = new JSONObject();
						if(adPostAttachObj.getIvrBnFILE_TYPE() == 1)
						{
							...
							images.put("img_url",getText("SOCIAL_INDIA_BASE_URL") +"/templogo/complaint/mobile/"+adPostAttachObj.getPostUniqueId().getPostUniqueId()+"/"+adPostAttachObj.getAttachName());
							}else{
								images.put("img_url","");
							}
						 ...
						 if(adPostAttachObj.getIvrBnFILE_TYPE() == 2)
						{
							...
							comVido.put("thumb_img", getText("SOCIAL_INDIA_BASE_URL") +"/templogo/complaint/thumbimage/"+adPostAttachObj.getPostUniqueId().getPostUniqueId()+"/"+adPostAttachObj.getThumbImage());
							}else{
								comVido.put("thumb_img","");
							}if(adPostAttachObj.getAttachName()!=null){
							comVido.put("video_url", getText("SOCIAL_INDIA_BASE_URL") +"/templogo/complaint/videos/"+adPostAttachObj.getPostUniqueId().getPostUniqueId()+"/"+adPostAttachObj.getAttachName());
							}else{
