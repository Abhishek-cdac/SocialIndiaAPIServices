			...
			System.out.println("societyid============== "+societyidval);
				...
				for (Iterator<ComplaintsTblVO> it = complaintsList
					...
					if(complaintsObj.getUsrRegTblByFromUsrId().getImageNameMobile()!=null){
						finalJsonarr.put("profile_pic",Commonutility.toCheckNullEmpty(getText("SOCIAL_INDIA_BASE_URL") +"/templogo/profile/mobile/"+complaintsObj.getUsrRegTblByFromUsrId().getImageNameMobile()));}
						else
						{
