...
public class PrivacyListCategory extends ActionSupport{
	...
	public String execute() {
		...
		try {
			...
			int startLimit = 0;
			Date timeStamp = null;
			log.logMessage("Enter into PrivacyListCategory ", "info", PrivacyListCategory.class);
			...
			log.logMessage("flg :" +flg, "info", PrivacyListCategory.class);
			if (flg) {
				locObjRspdataJson=new JSONObject();
				FeedDAO feedserviceObj = new FeedDAOService();
				String networkMemberCnt = feedserviceObj.totalNoNetworkUser(rid);
				JsonpackDao jsonPack = new JsonpackDaoService();
				JSONArray jsonArry = new JSONArray();
				jsonArry = jsonPack.privacyListCategory();
				locObjRspdataJson.put("categories", jsonArry);
			...
			locObjRspdataJson=new JSONObject();
			log.logMessage(getText("Eex") + ex, "error", PrivacyListCategory.class);
